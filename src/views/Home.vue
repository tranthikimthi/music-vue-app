...
import A_Little_Love from "@/music/A_Little_Love_Fiona_Fung.mp3";
import Cry_On_My_Shoulder from "@/music/Cry_On_My_Shoulder_Deutschland_Sucht_D.mp3";
import Lemon_Tree from "@/music/Lemon_Tree_Fools_Garden.mp3";
import Nothing_s_Gonna_Change_My_Love_For_You from "@/music/Nothing_s_Gonna_Change_My_Love_For_You_Westlife.mp3";
import Pround_Of_You from "@/music/Pround_Of_You_Fiona_Fung.mp3";
  ...
  setup() {
    const audios = ref([
      ...
      },
      {
        ...
        file: Cry_On_My_Shoulder,
        artist: "Deutschland Sucht D",
        howl: null,
      },
      {
        name: "Lemon Tree",
      ...
      },
      {
        ...
        file: Nothing_s_Gonna_Change_My_Love_For_You,
        artist: "Westlife",
        howl: null,
      },
      {
    ...
    function stepFunction() {
      const sound = audios.value[index.value].howl;
